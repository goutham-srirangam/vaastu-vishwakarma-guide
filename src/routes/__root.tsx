...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Traditional Vaastu Shastra guidance for homes, businesses, factories, restaurants and hospitals — by Vishwakarma Telugu Vaastu." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Marcellus&family=Dancing+Script:wght@500;600;700&family=Inter:wght@400;500;600;700&display=swap",
      },
    ],
  }),
